...
parser.add_argument('--check_path', type=str, default='/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/STARE/UNetMRFG/1/checkpoints/periods/8.pt',
...
basic_path = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/STARE_CHASE/21/'
...
test_imgs = get_green(test_imgs_original)
test_imgs = dataset_normalized(test_imgs)
