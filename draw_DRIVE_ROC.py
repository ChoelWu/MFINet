...
data_path = './datasets/DRIVE/'  # 数据集路径
...
model_path_UNet = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/DRIVE/UNet/2/checkpoints/periods/1_result_average/'
pred_imgs_UNet = np.load(model_path_UNet + 'pred_imgs.npy')

model_path_UNetFG = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/DRIVE/UNetFG/1/checkpoints/periods/10_result_average/'
pred_imgs_UNetFG = np.load(model_path_UNetFG + 'pred_imgs.npy')

model_path_UNetMR = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/DRIVE/UNetMR/1/checkpoints/periods/34_result_average/'
pred_imgs_UNetMR = np.load(model_path_UNetMR + 'pred_imgs.npy')

model_path_UNetMRFG = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/DRIVE/UNetMRFG/1/checkpoints/periods/56_result_average/'
pred_imgs_UNetMRFG = np.load(model_path_UNetMRFG + 'pred_imgs.npy')

model_path_UNetMI = '/home/sdc_3_7T/jiangyun/wuchao/MSINet/logs/DRIVE/UNetMI/2/checkpoints/periods/30_result_average/'
...
plt.axis([0, 1, 0.94, 1])
plt.title('DRIVE ROC curve', font_title)
plt.savefig("./pred/DRIVE_AUC_ROC.eps")
plt.show()
